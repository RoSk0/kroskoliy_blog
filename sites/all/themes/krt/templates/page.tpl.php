...
<div id="wrapper">
  <header id="header" class="clearfix">
    <?php if (theme_get_setting('image_logo','krt')): ?>
  ...
  <div id="main" class="clearfix">
    <div id="primary">
      <section id="content" role="main">
        ...
        $slide1_desc = check_markup(theme_get_setting('slide1_desc', 'krt'), 'full_html');
        $slide2_desc = check_markup(theme_get_setting('slide2_desc', 'krt'), 'full_html');
        $slide3_desc = check_markup(theme_get_setting('slide3_desc', 'krt'), 'full_html');
        ?>
        <div id="slider">
          <div id="slider-wrap">
